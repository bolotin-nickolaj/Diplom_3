import allure
from pages.head_page import HeadPage as HeadPage
from pages.personal_account_page import PersonalAccountPage as PersonalAccountPage
from pages.login_page import LoginPage as LoginPage
